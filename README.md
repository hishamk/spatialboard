...
<p align="center">
  <sub>
    ...
    click it to <a href="https://spatialboard.hishamkhalifa.com/dev-app/?board=mission-control">open
    it live</a>. The clocks, telemetry cards, timers, and 3D wireframe are
    custom nodes built with the same public API as the built-in stickies,
    frames, text, and connectors.
  </sub>
</p>
