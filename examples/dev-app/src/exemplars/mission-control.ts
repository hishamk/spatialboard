...
export function loadMissionControlBoard(engine: SpatialEngine): void {
  ...
  engine.addNode({
    ...
    h: "auto",
    z: z++,
    data: { text: "Wake & Systems Check", fontSize: 13, fontFamily: "ui-sans-serif, system-ui, sans-serif", color: "#93c5fd", align: "center" },
  });
  ...
  engine.addNode({
    ...
    h: "auto",
    z: z++,
    data: { text: "Drive to Waypoint 7", fontSize: 13, fontFamily: "ui-sans-serif, system-ui, sans-serif", color: "#86efac", align: "center" },
  });
  ...
  engine.addNode({
    ...
    h: "auto",
    z: z++,
    data: { text: "Rock Abrasion & Sample", fontSize: 13, fontFamily: "ui-sans-serif, system-ui, sans-serif", color: "#fcd34d", align: "center" },
  });
  ...
  engine.addNode({
    ...
    h: "auto",
    z: z++,
    data: { text: "Data Downlink & Sleep", fontSize: 13, fontFamily: "ui-sans-serif, system-ui, sans-serif", color: "#c4b5fd", align: "center" },
  });
  ...
  engine.addNode({
    ...
    data: { text: "06:00 LMST", fontSize: 10, fontFamily: "ui-sans-serif, system-ui, sans-serif", color: "#666", align: "center" },
  });
  engine.addNode({
    id: "time-2",
    type: "text",
    x: 390, y: 910, w: 140, h: "auto", z: z++,
    data: { text: "08:30 LMST", fontSize: 10, fontFamily: "ui-sans-serif, system-ui, sans-serif", color: "#666", align: "center" },
  });
  engine.addNode({
    id: "time-3",
    type: "text",
    x: 650, y: 910, w: 140, h: "auto", z: z++,
    data: { text: "12:00 LMST", fontSize: 10, fontFamily: "ui-sans-serif, system-ui, sans-serif", color: "#666", align: "center" },
  });
  engine.addNode({
    id: "time-4",
    type: "text",
    x: 910, y: 910, w: 140, h: "auto", z: z++,
    data: { text: "16:00 LMST", fontSize: 10, fontFamily: "ui-sans-serif, system-ui, sans-serif", color: "#666", align: "center" },
  });
  ...
  engine.addNode({
    ...
    h: "auto",
    z: z++,
    data: { text: "55%", fontSize: 12, fontFamily: "ui-sans-serif, system-ui, sans-serif", color: "#22c55e", align: "left" },
  });
