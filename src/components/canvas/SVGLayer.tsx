 ...
 *
 * Node rendering has been moved to VectorNodeBlock in the unified DOM layer.
 */
    ...
    >
      <g transform={svgTransform}>
        ...
        {registry && !hidePortDots && (() => {
          ...
          const expectedDir: PortDirection | null =
          ...
          return nodes
            ...
            .map((node) => {
              ...
              const renderPort = (port: typeof ports[number], _i: number, _portsOfDir: typeof ports, direction: PortDirection) => {
