 ...
 */
export const SpatialBoardReadOnlyContext = createContext<boolean>(false);

/** Hook: subscribe to the SpatialBoard readOnly flag. */
export function useSpatialBoardReadOnly(): boolean {
  return useContext(SpatialBoardReadOnlyContext);
}
