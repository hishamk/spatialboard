...
class EditorErrorBoundary extends Component<EditorErrorBoundaryProps, EditorErrorBoundaryState> {
  ...
  componentDidCatch(error: Error, info: ErrorInfo) {
    console.error("[ContentBlock] Editor mount failed, showing markdown fallback:", error, info);
  }
...
function ContentBlock({
  ...
  useEffect(() => {
    ...
    const rafId = requestAnimationFrame(() => {
      ...
      console.warn("[ContentBlock] All block rendering strategies failed, using markdown fallback");
      setUseFallback(true);
    });
